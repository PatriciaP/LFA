...
public class GraphViz
{
    ...
    public GraphViz() {
        if (GraphViz.osName.contains("Windows")) {
            this.dir = "C:\\Users\\patri\\Documents\\IFMG\\6_Periodo\\LFA\\src\\main\\resources\\output";
            this.executable = "C:\\Program Files (x86)\\graphviz-2.38\\release\\bin\\dot.exe";
     ...
     */
    public GraphViz(String executable, String dir) {
    ...
    private byte[] get_img_stream(File dot, String type, String representationType)
    {
        ...
        try {
            img = File.createTempFile("graph_", "." + type, new File(this.dir));
            ...
            System.err.println("Error:    in I/O processing of tempfile in dir " + dir + "\n");
    ...
    private File writeDotSourceToFile(String str) throws java.io.IOException
    {
        File temp;
        try {
            temp = File.createTempFile("graph_", ".dot.tmp", new File(dir));
